  ...
  methods: {
    ...
    fetchFile: function fetchFile(type, page) {
      ...
      axios.get('files/' + type + '?page=' + page).then(function (result) {
        ...
        console.log('fetch file result: ', _this.files);
    ...
    submitForm: function submitForm() {
      ...
      console.log('form data appended..', this.formData);
    ...
    endEditing: function endEditing(file) {
      ...
      axios.post('files/edit/' + file.id, formData).then(function (response) {
        ...
        console.log('end editing error: ', error);
...
__webpack_require__(/*! /Users/macuser/Desktop/projects/file_upload/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /Users/macuser/Desktop/projects/file_upload/resources/sass/app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! /Users/macuser/Desktop/projects/file_upload/resources/sass/font-awesome.scss */"./resources/sass/font-awesome.scss");
